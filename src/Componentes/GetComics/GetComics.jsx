      ...
      </div>
      {
        comics.length>0?
          <div className='d-flex justify-content-center align-items-center mt-3'>
            <button  onClick={prevPage}disabled={page === 0} className='buscador-paginacion-boton'>Previous Comics </button>
            <p className='m-0 mx-3'>{page + 1} de {totalPages}</p>
            <button onClick={nextPage} disabled={page === totalPages - 1} className='buscador-paginacion-boton'>Next Comics</button>
          </div>
          :
          null
      }
